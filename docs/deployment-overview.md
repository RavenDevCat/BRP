...
- `brp-kr.example.com` -> React frontend behind Cloudflare Access
- `react-brp-kr.example.com` -> optional React preview hostname, must be configured in Cloudflare before use
