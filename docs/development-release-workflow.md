...
react-brp.example.com/api/* -> 127.0.0.1:8001
```
...
curl -I https://react-brp.example.com/jobs
curl -s https://react-brp.example.com/api/health
```

Browser QA before switching `brp.example.com`:
