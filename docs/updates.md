...
- Deployed the React preview stack to the KR server for Tailscale-based QA.
...
- The KR public frontend origin behind `brp-kr.ravenapis.com` now serves the React frontend instead of Streamlit.
...
- Restored local historical job browsing after moving the project out of OneDrive into `/Users/alexus/Developer/BRP`.
