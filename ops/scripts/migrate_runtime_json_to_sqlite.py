...
from runtime_store_sqlite import RuntimeJsonPaths, migrate_json_runtime_to_sqlite  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Migrate BRP JSON runtime records into SQLite.")
...
def main() -> int:
    ...
    summary = migrate_json_runtime_to_sqlite(paths, args.sqlite_path.expanduser())
    summary.update({
