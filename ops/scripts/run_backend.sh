...
mkdir -p "$BRP_BACKEND_JOBS_DIR"

BRP_BACKEND_HOST="$BRP_BACKEND_HOST" BRP_BACKEND_PORT="$BRP_BACKEND_PORT" BRP_BACKEND_JOBS_DIR="$BRP_BACKEND_JOBS_DIR" "$BACKEND_PYTHON" backend_service.py
